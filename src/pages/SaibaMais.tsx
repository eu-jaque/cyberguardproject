...
const services: ServiceRow[] = [
  ...
  { name: "Hands-on", description: "Treinamento prático e imersivo para sua equipe, com exercícios reais de detecção e resposta a incidentes de segurança.", basico: false, avancado: false, profissional: false, enterprise: true },
